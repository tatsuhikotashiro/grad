...
int main(int argc, char *argv[])
{
    ...
    while (timeMinutes < endTime)
    {
        ...
        { // 条件を変更
            ...
            else if (fifo(data.at(waitingCustomerNumber).at(1), data.at(waitingCustomerNumber).at(2), SeatsStay2, cap2))
            {
                // 2席占有されるので反映する
            ...
            else if (fifo(data.at(waitingCustomerNumber).at(1), data.at(waitingCustomerNumber).at(2), SeatsStay3, cap3))
            {
            ...
            else if (fifo(data.at(waitingCustomerNumber).at(1), data.at(waitingCustomerNumber).at(2), SeatsStay4, cap4))
            {
