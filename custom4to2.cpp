...
int main(int argc, char* args[]){
    ...
    std::ofstream ofs("customerData2to4.txt");
    if (!ofs.is_open())
    {
    ...
    for(int i = 0;i < (int)customersData.size();i++){
        if(customersData.at(i).at(2) == 4){
        ofs << customersData.at(i).at(0) << ' ' << customersData.at(i).at(1) << ' ' << 2 << std::endl;
        ofs << customersData.at(i).at(0) << ' ' << customersData.at(i).at(1) << ' ' << 2 << std::endl;
        }
        else{
        ofs << customersData.at(i).at(0) << ' ' << customersData.at(i).at(1) << ' ' << customersData.at(i).at(2) << std::endl;
        }
    }
}